...
data <- read.csv(file=("/users/shmabe/GitHub/Gabe-Repository/Data/Figure4Data.csv"), header=T)
...
ggsave(filename=paste("/users/shmabe/GitHub/Gabe-Repository/Data/Figure4Data.csv",
