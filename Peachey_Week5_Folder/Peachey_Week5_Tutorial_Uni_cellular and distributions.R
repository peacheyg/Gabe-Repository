...
setwd("/users/shmabe/GitHub/R4Eco_2022/Week5")
...
# First, we'll recreate the plot and analysis from the paper for Figure 1(c).
  ...
  # These data were downloaded from: http://myxo.css.msu.edu/ecoli/
...
# Distributions ####
# As we've discussed, distributions (think histograms) can tell you a lot ecologically.
...
gofstat(list(fit.norm, fit.logis, fit.weibull, fit.gamma))
  ...
  # The Weibull distribution has a lower AIC, and is the best fit.
