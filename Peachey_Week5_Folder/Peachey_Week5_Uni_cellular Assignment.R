...
A Kruskal-Wallis test was used rather than an ANOVA most likely because the strains did not have even, "normal" distributions, which are necessary for using an ANOVA.
...
# Based on the AIC scores, which distribution is the best fit for: (4 pts)
  # (1) - The number of cells of progeny (data$Num.Cells.Progeny)?
AIC(data$Num.Cells.Progeny)
  # (2) - The replication time (data$RepTime.sec)?
AIC(data$RepTime.sec)
