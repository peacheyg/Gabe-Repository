...
#This is not an interpretation, it's a rehash of Part 1.
...
#p-value is not the only reason, and is only one of several ways we can decide which is the best fit for the data without over-fitting.
